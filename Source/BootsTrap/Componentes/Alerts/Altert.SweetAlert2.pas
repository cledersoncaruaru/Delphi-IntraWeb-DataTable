...
interface
  ...
  Function Lib_JS_SweetAlert2 :String;
...
Function Lib_CSS_SweetAlert2 :String;
begin
  Result := '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/8.11.8/sweetalert2.min.css" />';
end;

Function Lib_JS_SweetAlert2 :String;
Begin
  Result := '  <script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/8.11.8/sweetalert2.min.js"></script>';
End;
